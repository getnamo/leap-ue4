...
#include "AnimGraphNode_ModifyHand.generated.h"


UCLASS(MinimalAPI)
class UAnimGraphNode_ModifyHand : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()

		UPROPERTY(EditAnywhere, Category = Settings)
		FAnimNode_ModifyHand Node;
...
protected:
	...
	void DoRotationOneBone(const USkeletalMeshComponent* SkelComp, FRotator& Rotation, FAnimNode_ModifyHand* ModifyNode, FRotator* ModifyNodeBoneRotation, FBoneReference* CurrentNodeBone, FRotator* CurrentNodeBoneRotation);
