...
#include "AnimGraphNode_ModifyFinger.h"
#include "CompilerResultsLog.h"

/////////////////////////////////////////////////////
// UAnimGraphNode_ModifyFinger

DEFINE_LOG_CATEGORY(LeapNodeLog);

#define LOCTEXT_NAMESPACE "A3Nodes"

UAnimGraphNode_ModifyFinger::UAnimGraphNode_ModifyFinger(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	CurWidgetMode = (int32)FWidget::WM_Rotate;
}

void UAnimGraphNode_ModifyFinger::ValidateAnimNodeDuringCompilation(USkeleton* ForSkeleton, FCompilerResultsLog& MessageLog)
{
	ValidateAnimNodeDuringCompilationOneBone(ForSkeleton, &Node.TargetFingerBone1, MessageLog);
	ValidateAnimNodeDuringCompilationOneBone(ForSkeleton, &Node.TargetFingerBone2, MessageLog);
	ValidateAnimNodeDuringCompilationOneBone(ForSkeleton, &Node.TargetFingerBone3, MessageLog);

	Super::ValidateAnimNodeDuringCompilation(ForSkeleton, MessageLog);
}

void UAnimGraphNode_ModifyFinger::ValidateAnimNodeDuringCompilationOneBone(USkeleton* ForSkeleton, FBoneReference* BoneToValidate, FCompilerResultsLog &MessageLog)
{
...
FText UAnimGraphNode_ModifyFinger::GetControllerDescription() const
{
	return LOCTEXT("TransformModifyFinger", "Transform (Modify) Finger");
}

FText UAnimGraphNode_ModifyFinger::GetTooltipText() const
{
...
FText UAnimGraphNode_ModifyFinger::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
...
int32 UAnimGraphNode_ModifyFinger::GetWidgetCoordinateSystem(const USkeletalMeshComponent* SkelComp)
{
...
FVector UAnimGraphNode_ModifyFinger::GetWidgetLocation(const USkeletalMeshComponent* SkelComp, FAnimNode_SkeletalControlBase* AnimNode)
{
...
EBoneModificationMode UAnimGraphNode_ModifyFinger::GetBoneModificationMode(int32 InWidgetMode)
{
...
int32 UAnimGraphNode_ModifyFinger::GetNextWidgetMode(int32 InWidgetMode)
{
	FWidget::EWidgetMode InMode = (FWidget::EWidgetMode)InWidgetMode;
	switch (InMode)
	{
...
int32 UAnimGraphNode_ModifyFinger::FindValidWidgetMode(int32 InWidgetMode)
{
	FWidget::EWidgetMode InMode = (FWidget::EWidgetMode)InWidgetMode;
...
int32 UAnimGraphNode_ModifyFinger::GetWidgetMode(const USkeletalMeshComponent* SkelComp)
{
	int32 BoneIndex = SkelComp->GetBoneIndex(Node.TargetFingerBone1.BoneName);
	if (BoneIndex != INDEX_NONE)
	{
...
int32 UAnimGraphNode_ModifyFinger::ChangeToNextWidgetMode(const USkeletalMeshComponent* SkelComp, int32 InCurWidgetMode)
{
...
bool UAnimGraphNode_ModifyFinger::SetWidgetMode(const USkeletalMeshComponent* SkelComp, int32 InWidgetMode)
{
...
FName UAnimGraphNode_ModifyFinger::FindSelectedBone()
{
	return Node.TargetFingerBone1.BoneName;
}

void UAnimGraphNode_ModifyFinger::DoTranslation(const USkeletalMeshComponent* SkelComp, FVector& Drag, FAnimNode_Base* InOutAnimNode)
{
	FAnimNode_ModifyFinger* ModifyBone = static_cast<FAnimNode_ModifyFinger*>(InOutAnimNode);
...
void UAnimGraphNode_ModifyFinger::DoRotation(const USkeletalMeshComponent* SkelComp, FRotator& Rotation, FAnimNode_Base* InOutAnimNode)
{
	FAnimNode_ModifyFinger* ModifyBone = static_cast<FAnimNode_ModifyFinger*>(InOutAnimNode);
...
void UAnimGraphNode_ModifyFinger::DoRotationOneBone(const USkeletalMeshComponent* SkelComp, FRotator& Rotation, FAnimNode_ModifyFinger* ModifyNode, FRotator* ModifyNodeBoneRotation, FBoneReference* CurrentNodeBone, FRotator* CurrentNodeBoneRotation)
{
...
void UAnimGraphNode_ModifyFinger::DoScale(const USkeletalMeshComponent* SkelComp, FVector& Scale, FAnimNode_Base* InOutAnimNode)
{
...
void UAnimGraphNode_ModifyFinger::CopyNodeDataTo(FAnimNode_Base* OutAnimNode)
{
	FAnimNode_ModifyFinger* ModifyBone = static_cast<FAnimNode_ModifyFinger*>(OutAnimNode);
...
void UAnimGraphNode_ModifyFinger::CopyNodeDataFrom(const FAnimNode_Base* InNewAnimNode)
{
	const FAnimNode_ModifyFinger* ModifyBone = static_cast<const FAnimNode_ModifyFinger*>(InNewAnimNode);
